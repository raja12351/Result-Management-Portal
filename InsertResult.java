...
public class InsertResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 406, Short.MAX_VALUE))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String machines = jTextField5.getText();
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("Select * from result_management.students where rollno='"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into result_management.results(rollno,physics,chemistry,maths,machines,dsa) values ('"+rollno+"','"+physics+"','"+chemistry+"','"+maths+"','"+machines+"','"+dsa+"')");
                JOptionPane.showMessageDialog(null,"Result is Updated Successfully.");
                setVisible(false);
                new InsertResult().setVisible(true);
            }
            else{
